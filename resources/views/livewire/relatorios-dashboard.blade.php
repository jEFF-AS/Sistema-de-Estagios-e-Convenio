<div>
    ...
    <form wire:submit.prevent="filtrar" class="bg-white border border-gray-200 rounded-2xl p-5 mb-6 shadow-sm">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 items-start">
            ...
            <div class="flex gap-2 mt-[22px] w-full">
                @if($filtrado)
                <button type="button" wire:click="limparFiltro" class="bg-gray-500 hover:bg-gray-600 text-white px-4 py-2.5 rounded-xl text-xs font-bold shadow-md transition uppercase tracking-wider white-space-nowrap">
                    Limpar
                </button>
                @endif
